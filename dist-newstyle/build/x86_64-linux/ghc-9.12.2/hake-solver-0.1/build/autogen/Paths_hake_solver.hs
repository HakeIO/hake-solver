...
-- at runtime using the environment variable hake_solver_bindir.
...
-- environment variable hake_solver_libdir.
...
-- using the environment variable hake_solver_dynlibdir.
...
-- runtime using the environment variable hake_solver_datadir.
...
-- variable hake_solver_libexedir.
...
-- using the environment variable hake_solver_sysconfdir.
...
libdir     = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33/hake-solver-0.1-inplace"
dynlibdir  = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33"
datadir    = "/home/runner/.cabal/share/x86_64-linux-ghc-9.12.2-9b33/hake-solver-0.1"
libexecdir = "/home/runner/.cabal/libexec/x86_64-linux-ghc-9.12.2-9b33/hake-solver-0.1"
sysconfdir = "/home/runner/.cabal/etc"

getBinDir     = catchIO (getEnv "hake_solver_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "hake_solver_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "hake_solver_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "hake_solver_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "hake_solver_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "hake_solver_sysconfdir") (\_ -> return sysconfdir)
